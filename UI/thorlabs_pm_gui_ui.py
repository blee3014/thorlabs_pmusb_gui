...
class Ui_wMainWindow(object):
    def setupUi(self, wMainWindow):
        ...
        self.gridLayout_4.addWidget(self.label_2, 7, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.spinBox, 1, 2, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.checkBox_2, 4, 2, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.comboBox, 5, 2, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.lineEdit, 7, 2, 1, 2)

        self.pushButton = QPushButton(self.groupBox_3)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setEnabled(False)

        self.gridLayout_4.addWidget(self.pushButton, 7, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox, 3, 2, 1, 3)
        ...
        self.label_15.setGeometry(QRect(240, 250, 351, 131))
        font2 = QFont()
    ...
    def retranslateUi(self, wMainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("wMainWindow", u"W", None))
        ...
        self.checkBox_2.setText(QCoreApplication.translate("wMainWindow", u"Auto Range", u"0"))
        self.comboBox.setItemText(0, QCoreApplication.translate("wMainWindow", u"W", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("wMainWindow", u"dBm", None))

        self.pushButton.setText(QCoreApplication.translate("wMainWindow", u"Zero", None))
        ...
        self.checkBox.setText(QCoreApplication.translate("wMainWindow", u"Low Pass Filter", u"0"))
        self.groupBox_4.setTitle("")
        self.label_14.setText(QCoreApplication.translate("wMainWindow", u"Power", None))
        self.label_15.setText(QCoreApplication.translate("wMainWindow", u"28.123", None))
